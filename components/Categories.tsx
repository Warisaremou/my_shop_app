...
export default function Categories({ open, setOpen }: categoriesProps) {
  return (
    <Transition.Root show={open} as={Fragment}>
      <Dialog as="div" className="relative z-10" onClose={setOpen}>
        <Transition.Child
          ...
          leaveTo="opacity-0"
        >
          <div className="fixed inset-0 bg-gray-800 backdrop-blur-sm bg-opacity-75 transition-opacity" />
        </Transition.Child>
              ...
              >
                <Dialog.Panel className="pointer-events-auto relative w-screen max-w-md">
                  ...
                  <div className="flex h-full flex-col overflow-y-scroll bg-white dark:bg-gray-900 py-6 shadow-xl">
                    ...
                    <div className="relative mt-6 flex-1 px-4 sm:px-6">hey</div>
                  </div>
                </Dialog.Panel>
              </Transition.Child>
            </div>
